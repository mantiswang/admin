...
app.controller('activeFailListController',['$scope', '$http','$modal','toaster',function ($scope,$http,$modal,toaster) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            ...
            { field: 'activeFailCount', displayName: '激活失败次数', width:'150px' },
    ...
    $scope.getPagedDataAsync = function (pageSize, page, searchText) {
        var url  = '/active/activeFail?page=' + page + '&size=' + pageSize + '&simCode=' + $scope.simCode + '&vehicleIdentifyNum='
