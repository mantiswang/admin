...
app.controller('deviceStatusFailListController', ['$scope', '$http', '$modal', 'toaster', function ($scope, $http, $modal, toaster) {
    ...
    $scope.getPagedDataAsync = function (pageSize, page, searchText) {
        var url = '/devices/fail?page=' + page + '&size=' + pageSize  +'&vehicleIdentifyNum=' +$scope.vehicleIdentifyNum +'&simCode=' +$scope.simCode;
