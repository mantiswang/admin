...
app.controller('updateStaffController', ['$scope', '$http', '$modal', '$modalInstance', 'sysUserId', function ($scope, $http, $modal, $modalInstance,sysUserId) {
    ...
    function init(){
        ...
        $http.get('staff/'+ sysUserId).success(function(data){
    ...
    $scope.update = function () {
        $http.put('staff/'+$scope.sysUser.id, $scope.sysUser).success(function (data) {
            $scope.close('SUCCESS');
        })
    }
